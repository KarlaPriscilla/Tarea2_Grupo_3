...
// Melodía de bienvenida alternativa (estilo clásico)
void melodia_bienvenida() {
    reproducir_nota(NOTA_DO, 180);
    reproducir_nota(NOTA_MI, 180);
    reproducir_nota(NOTA_SOL, 180);
    reproducir_nota(NOTA_DO_OCT, 360);

    Delay_ms(120);

    reproducir_nota(NOTA_SOL, 150);
    reproducir_nota(NOTA_FA, 150);
    ...
    reproducir_nota(NOTA_DO, 100);
    reproducir_nota(NOTA_RE, 100);
    reproducir_nota(NOTA_MI, 100);
    reproducir_nota(NOTA_FA, 400);
}

// Melodía de victoria (estilo triunfal)
void melodia_victoria() {
    reproducir_nota(NOTA_SOL, 200);
    reproducir_nota(NOTA_LA, 200);
    reproducir_nota(NOTA_SI, 200);
    reproducir_nota(NOTA_DO_OCT, 400);

    Delay_ms(150);

    reproducir_nota(NOTA_DO_OCT, 150);
    reproducir_nota(NOTA_SI, 150);
    reproducir_nota(NOTA_LA, 150);
    reproducir_nota(NOTA_SOL, 300);
}

// Melodía de derrota (tono descendente)
void melodia_derrota() {
    reproducir_nota(NOTA_DO_OCT, 300);
    reproducir_nota(NOTA_SI, 300);
    reproducir_nota(NOTA_LA, 300);
    reproducir_nota(NOTA_SOL, 300);
    reproducir_nota(NOTA_FA, 300);
    reproducir_nota(NOTA_MI, 300);
    reproducir_nota(NOTA_RE, 300);
    reproducir_nota(NOTA_DO, 600);
}
